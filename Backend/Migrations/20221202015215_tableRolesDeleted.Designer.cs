...
namespace Backend.Migrations
{
    ...
    [Migration("20221202015215_tableRolesDeleted")]
    partial class tableRolesDeleted
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Entities.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 12, 2, 1, 52, 15, 146, DateTimeKind.Utc).AddTicks(7710));
            ...
            modelBuilder.Entity("Backend.Entities.Thing", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 12, 2, 1, 52, 15, 146, DateTimeKind.Utc).AddTicks(8165));
            ...
            modelBuilder.Entity("Backend.Entities.User", b =>
                {
                    b.HasOne("Backend.Entities.Role", "Rol")
                        .WithMany()
                        .HasForeignKey("RolId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
